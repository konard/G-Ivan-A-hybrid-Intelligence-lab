...
require_text "$stress_test" "ops/backlog.md"
...
require_text "ops/artifact-map.md" "/ai-rules/adversarial-stress-testing.md"
require_text "ops/artifact-map.md" "/ai-governance/agent-security-checklist.md"

...
require_text "AI_GOVERNANCE.md" "version: 1.5"
...
require_text "standards/README.md" "version: 1.3"
...
require_text "standards/session-handover-standard.md" "version: 0.1"
require_text "standards/session-handover-standard.md" "updated: 2026-06-11"
...
require_text "governance/rfc/htom-vs-spoke-clarification-2026-06.md" "status: canonical"
require_text "governance/rfc/htom-vs-spoke-clarification-2026-06.md" "ai-generated: true"
...
require_text "governance/rfc/knowledge-lifecycle-proposal.md" "version: 0.1"
...
require_text "governance/rfc/knowledge-lifecycle-proposal.md" "Founder review"
require_text "governance/rfc/knowledge-lifecycle-proposal.md" "explicit Founder approval"
require_text "governance/rfc/resolve-artifact-location-proposal.md" "status: draft"
require_text "governance/rfc/resolve-artifact-location-proposal.md" "version: 0.1"
...
require_text "governance/rfc/resolve-artifact-location-proposal.md" "explicit Founder approval"
require_text "governance/rfc/product-concept-template-proposal.md" "status: draft"
require_text "governance/rfc/product-concept-template-proposal.md" "version: 0.1"
...
require_text "governance/rfc/product-concept-template-proposal.md" "explicit Founder approval"
require_text "governance/rfc/solution-concept-template-proposal.md" "status: draft"
require_text "governance/rfc/solution-concept-template-proposal.md" "version: 0.1"
...
require_text "governance/rfc/solution-concept-template-proposal.md" "explicit Founder approval"
...
require_text "research/mango/classification.md" "source: git history before migration to research/mango/classification.md"
require_text "research/mango/classification-tz.md" "status: reviewed"
require_text "research/mango/classification-tz.md" "source: git history before migration to research/mango/classification-tz.md"
require_text "research/mango/requirements-flow.md" "status: reviewed"
require_text "research/mango/requirements-flow.md" "source: git history before migration to research/mango/requirements-flow.md"

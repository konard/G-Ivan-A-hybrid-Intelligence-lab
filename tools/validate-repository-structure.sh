...
is_active_file() {
  case "$1" in
    ...
    research/ai-education/evaluation/10-theory.md | \
    research/ai-education/evaluation/20-taxonomy.md | \
    ...
    research/ai-education/agent-context-engineering/00-introduction.md | \
    research/ai-education/agent-context-engineering/10-theory.md | \
    research/ai-education/agent-context-engineering/20-taxonomy.md | \
    research/ai-education/agent-context-engineering/30-decision-framework.md | \
    research/ai-education/agent-context-engineering/40-practice-and-cases.md | \
    research/ai-education/agent-context-engineering/50-open-research.md | \
    research/ai-education/agent-delivery-and-release/00-introduction.md | \
    research/ai-education/agent-delivery-and-release/10-theory.md | \
    research/ai-education/agent-delivery-and-release/20-taxonomy.md | \
    research/ai-education/agent-delivery-and-release/30-decision-framework.md | \
    research/ai-education/agent-delivery-and-release/40-practice-and-cases.md | \
    research/ai-education/agent-delivery-and-release/50-open-research.md | \
...
require_text "docs/adr/2026-08-adr-011-research-models.md" "status: accepted"
...
require_text "standards/research-standard.md" "research_model"
...
require_text "standards/report-standard.md" "Type Model"
...
require_text "standards/analysis-standard.md" "Type Model"
...
require_text "standards/issue-workflow.md" "version: 1.5"
require_text "standards/issue-workflow.md" "updated: 2026-09-05"
...
require_text "pr-ops/artifact-map.md" "version: 2.11"
...
require_text "pr-ops/artifact-map.md" "updated: 2026-09-08"
...
require_text "$rfc_541" "research/ba-requirements/exp/ba-artifact-pipeline-roadmap-541"

layering_check="research/ba-requirements/2026-08-26-m0-m2-layering-hypothesis-check.md"
require_file "$layering_check"
require_text "$layering_check" "status: draft"
require_text "$layering_check" "type: research"
require_text "$layering_check" "runs-routing.json"

layering_exp="research/ba-requirements/exp/ba-artifact-pipeline-roadmap-541"
require_file "$layering_exp/README.md"
...
require_text "pr-ops/backlog.md" "version: 1.58"

...
| Исторический промпт существует в трёх режимах | берётся один навык; формат вычисляется в поле `interaction` по наличию точки возврата управления актору, а не выбирается | `DP-1`…`DP-5`, `FM-1`, ADR-013, ADR-016 |

...
1. **Согласованность принципов.** Каждый принцип из
   [docs/concept.md](../../../docs/concept.md) сверен с местом его реализации в активных
   артефактах.
...
## ✅ Чек-лист согласованности с docs/concept.md

Проверены все восемь принципов из раздела «Принципы» `docs/concept.md`. Принцип
issue «Evidence-driven» соответствует принципу `Traceability` в `docs/concept.md`.

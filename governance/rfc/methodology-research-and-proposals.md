...
| **5. Product** | Каталог продуктов/процессов как предметная область. | Influence & Network Analysis (как один из доменов) | **Сильный для Mango:** Product Layer (`research/mango/classification.md`). |
...
(`Семейство → Класс → Подкласс → Функция`, `research/mango/classification.md`):
...
| **Capability Maturity (L0–L5)** | Зрелость capability продукта. | L0 Raw … L5 Managed | `research/mango/taxonomy-concept-2026-05.md` |

...
| **5. Product** | Каталог продуктов/процессов как предметная область. | Influence & Network Analysis (как один из доменов) | **Сильный для Mango:** Product Layer (`research/mango/2026-05-classification.md`). |
...
(`Семейство → Класс → Подкласс → Функция`, `research/mango/2026-05-classification.md`):
...
| **Capability Maturity (L0–L5)** | Зрелость capability продукта. | L0 Raw … L5 Managed | `research/mango/2026-05-taxonomy-concept.md` |
...
- [research/mango/2026-05-classification.md](../../research/mango/2026-05-classification.md) —

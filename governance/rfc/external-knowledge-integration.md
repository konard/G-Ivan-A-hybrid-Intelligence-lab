...
| `governance/rfc/external-knowledge-integration.md` | Этот RFC, `draft` | Остаётся `draft` до решения Founder & PO. |
...
> resolver-логике
> ([governance/rfc/resolve-artifact-location-proposal.md](resolve-artifact-location-proposal.md)).
...
- Артефакты зарегистрированы в `governance/artifact-map.md`, навигации и
...
- [governance/rfc/knowledge-lifecycle-proposal.md](knowledge-lifecycle-proposal.md) — жизненный цикл знаний.
- [governance/rfc/resolve-artifact-location-proposal.md](resolve-artifact-location-proposal.md) — выбор расположения артефакта.

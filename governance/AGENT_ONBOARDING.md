...
алгоритму ниже. Агент **не «живёт» в репозитории** — он *читает* его в
...
*Runtime-онбординг* — фаза **read-only**: до апрува человека (Шаг 4) агент ничего
не пишет в *Источник контекста*.

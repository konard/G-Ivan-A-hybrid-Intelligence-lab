...
related_issues:
  ...
  - "https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/336"
  ...
  - "https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/382"
---
...
| **B-027** | chore: Создание `standards/analysis-standard.md` | **P0** | B-026 | DONE (artifact: draft) | [#366](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/366) (PR [#369](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/369)) | Issue [#296](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/296); [ADR-006](../docs/adr/2026-07-adr-006-analysis-structure.md) (B-026); RFC B-025 ([governance/rfc/2026-07-02-rfc-analysis-structure.md](rfc/2026-07-02-rfc-analysis-structure.md)) | Нормативно зафиксирован базовый каркас Analysis как **interpretation layer** + опциональные профили подтипов (`inventory`/`matrix`/`options`/`recommendation`) как секции, relation-frontmatter, routing `docs/analysis/`, knowledge-lifecycle, триггер B (anti-inflation) и границы Analysis ↔ Research ↔ Audit ↔ Report ↔ RFC ↔ ADR. PR #369 merged. |
...
| [docs/analysis/2026-07-04-hub-migration-and-root-structure-plan.md](../docs/analysis/2026-07-04-hub-migration-and-root-structure-plan.md) | Результат B-034: upstream analysis/plan for ADR decision gate B-047 and physical migration B-048. |
| [docs/adr/2026-07-adr-007-hub-root-structure.md](../docs/adr/2026-07-adr-007-hub-root-structure.md) | Accepted ADR for issue #378 / B-047, refined by issue #382: founder decision on Hub root To-Be structure, full ADR-001 core + ADR-007 delta tree, provisional-standard mechanism and B-048 implementation strategy. |
...
ADR-007/B-047; physical split B-056 remains downstream from B-048 and accepted
B-047. Cross-standard stress-test follow-ups form a separate repair chain:
...
flowchart TD
    ...
    B020["B-020 · DONE<br/>glossary terms<br/>R/A/A + RFC/ADR/Standard"]
    ...
    B027["B-027 · DONE<br/>analysis-standard.md<br/>structure standard"]
    ...
    B047["B-047 · DONE<br/>ADR-007 Hub root<br/>accepted decision gate"]
    ...
    B055["B-055 · DONE<br/>ai-governance vs ai-rules<br/>absorbed by ADR-007"]

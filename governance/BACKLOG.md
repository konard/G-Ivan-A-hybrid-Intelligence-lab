...
| **B-004** | Зафиксировать двухкейсовую модель инициализации в `governance/REPO_MODEL.md` | **P1** | — | DONE | [#111](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/111) | RFC-два-кейса (follow-up #2) | Закрепляет концептуальный фундамент в каноне; снижает риск повторной терминологической путаницы (ошибка №5 ретроспективы). |
...
**Критерии приёмки (DoD):**
- [x] В `REPO_MODEL.md` есть раздел о двух кейсах со ссылками на GLOSSARY и
      RFC-манифест.
...
| [governance/proposals/rfc-creative-template-design.md](proposals/rfc-creative-template-design.md) | Контекст генома `templates/spoke/`; первый bootstrap вынесен за пределы текущего бэклога. |

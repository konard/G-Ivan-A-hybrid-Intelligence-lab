...
| `/governance/backlog.md` | навигация | — | Единый бэклог работ Хаба (Sprint 3): сводная таблица задач, приоритеты P0–P3, зависимости и критический путь, источники, открытые вопросы из session digests, креативный анализ рекомендаций команд С и Q, North Star и триггеры пересмотра. Ортогонален этой карте: карта показывает «что есть», бэклог — «что осталось». Решение по приоритетам за человеком. | ✅ Да | `governance/agent-onboarding-protocol.md`, `governance/session-digests.md`, `governance/rfc/rfc-two-cases-of-project-initialization.md`, `research/hub/external-governance-patterns-review-2026-06.md`, `standards/glossary.md` |
...
| `/practices/README.md` | навигация | справка | Каталог фиксированных практик: разделяет research, fixed practices, templates и project adaptation; задаёт требования Source, author, link для practice nodes. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `research/hub/international-ai-governance-practices-2026-06.md`, `standards/executable-documentation-standard.md` |
| `/practices/agent-work/README.md` | навигация | справка | Индекс атомарных agent-work practices для AI-assisted issues, PRs и project sync. | ✅ Да | `practices/README.md`, `research/hub/external-practice-intake-2026-06.md` |
| `/practices/agent-work/hybrid-search-before-action.md` | руководство | 🚦 да | Практика предварительного hybrid search: structured search и contextual reading перед изменениями. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `tools/validate-repository-structure.sh` |
| `/practices/agent-work/definition-of-ready-check.md` | руководство | 🚦 да | Практика Definition of Ready для превращения broad tasks в reviewable artifacts, acceptance checks и unknowns. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `.github/ISSUE_TEMPLATE/task.md` |
| `/practices/agent-work/plan-verify-ship-loop.md` | руководство | 🚦 да | Практика Explore -> Plan -> Code -> Test -> Review -> Ship для non-trivial Hub issues. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `CONTRIBUTING.md` |
| `/practices/agent-work/skills-as-reusable-workflows.md` | руководство | 🚦 да | Практика продвижения повторяющихся agent workflows в reusable skills/templates/practice nodes. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `templates/manifest.json` |
| `/practices/agent-work/skill-catalog-token-budget.md` | руководство | 🚦 да | Практика token-budget discipline для больших каталогов навыков и практик: индексы вместо prompt overload. | ✅ Да | `research/hub/external-practice-intake-2026-06.md`, `practices/README.md` |
| `/practices/ai-governance/README.md` | навигация | справка | Индекс AI governance practice nodes, адаптированных из NIST, EU AI Act, ISO/IEC 42001, OpenAI, Anthropic и Google SAIF. | ✅ Да | `practices/README.md`, `research/hub/international-ai-governance-practices-2026-06.md` |
| `/practices/ai-governance/nist-ai-rmf-profile-loop.md` | руководство | 🚦 да | Практика Map, Measure, Manage, Govern для lightweight risk profile в AI-assisted workflows. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `AI_GOVERNANCE.md` |
| `/practices/ai-governance/eu-ai-act-risk-tiering.md` | руководство | 🚦 да | Практика risk tier triage по мотивам EU AI Act перед public/sensitive AI workflow. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `AI_GOVERNANCE.md` |
| `/practices/ai-governance/iso-42001-management-loop.md` | руководство | 🚦 да | Практика AI management system loop: policy, owner, process, check, continual improvement. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `standards/README.md` |
| `/practices/ai-governance/openai-evaluation-and-feedback-loop.md` | руководство | 🚦 да | Практика pre-release evaluations plus post-release feedback for AI-assisted workflows. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `tools/validate-repository-structure.sh` |
| `/practices/ai-governance/anthropic-capability-thresholds.md` | руководство | 🚦 да | Практика capability thresholds: stronger safeguards when agents gain power, autonomy or sensitive access. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `AI_GOVERNANCE.md` |
| `/practices/ai-governance/google-saif-agent-security.md` | руководство | 🚦 да | Практика SAIF-inspired agent security controls for tools, data, permissions, and autonomous actions. | ✅ Да | `research/hub/international-ai-governance-practices-2026-06.md`, `governance/agent-onboarding-protocol.md` |
...
| `/practices/agent-work/` | каталог | — | Практики работы AI-агентов: search, readiness, execution loop, reusable workflows и token budget. | ✅ Да | `practices/agent-work/README.md`, `research/hub/external-practice-intake-2026-06.md` |
| `/practices/ai-governance/` | каталог | — | AI governance practices, адаптированные из международных источников. | ✅ Да | `practices/ai-governance/README.md`, `research/hub/international-ai-governance-practices-2026-06.md` |

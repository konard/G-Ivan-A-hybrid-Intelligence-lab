...
| `/governance/agent-onboarding.md` | правило | 🚦 entrypoint | Рабочая инструкция *Runtime-онбординга* (Кейс 1): единый входной артефакт для нового агента — *Handover Prompt* с `{{REPO_NAME}}`, 4-шаговый протокол (governance → контекст → *Readback* → стоп до апрува), threat awareness «Что может пойти не так» и раздел Design Rationale & History. Точки входа — `README.md` и `AI_GOVERNANCE.md`. | ✅ Да | `README.md`, `AI_GOVERNANCE.md`, `governance/rfc/rfc-two-cases-of-project-initialization.md`, `governance/rfc/contract-executability-rfc.md`, `templates/spoke/README.md`, `standards/glossary.md` |
...
| `/templates/spoke/AI_GOVERNANCE.md` | шаблон | справка | Шаблон конституции спока: роли, правила, operating modes, эскалация и DoD. Ядро генома (обязателен в корне спока). Плейсхолдеры `{{project_name}}`, `{{hub_url}}`, `{{date}}`. | ⚠️ По необходимости | `templates/spoke/README.md`, `AI_GOVERNANCE.md`, `templates/spoke/AI_QUICK_RULES.md` |
...
| `/templates/spoke/AI_HANDOVER_PROMPT.md` | шаблон | 🚦 да | Копия *Handover Prompt* (с плейсхолдером `{{REPO_NAME}}`) в геноме спока: готовая «доверенность» для запуска агента (Runtime-онбординг). Источник истины — хабовый `governance/agent-onboarding.md`; спок хранит копию для самодостаточности. | ⚠️ По необходимости | `governance/agent-onboarding.md`, `templates/spoke/AI_QUICK_RULES.md`, `templates/spoke/README.md`, `governance/rfc/contract-executability-rfc.md` |
| `/templates/spoke/README.md` | шаблон | — | Шаблон визитки спока и canonical-точка входа Кейса 2 (Bootstrap-клонирование): цель, структура "сейчас", связь с Хабом и Design Decisions & Rationale для «ДНК-шаблона». | ⚠️ По необходимости | `templates/spoke/AI_GOVERNANCE.md`, `templates/spoke/CONTRIBUTING.md`, `governance/agent-onboarding.md`, `governance/rfc/rfc-two-cases-of-project-initialization.md`, `standards/file-naming.md` |
...
| `/research/portal/portal-documents-review-2026-06.md` | навигация | — | Markdown review-tool для согласования 10 отложенных portal-документов из repository-quality RFC: кликабельные ссылки, 2-3 sentence summaries, спорные вопросы исполнителя, места для решений фаундера, сводная матрица Q01-Q12 и DoD согласования. Scope: portal. | ✅ Да | `research/portal/open-ai-portal-concept-rfc.md`, `governance/rfc/repository-quality-improvement-plan.md`, `research/portal/portal-documents-review-2026-06.html` |
| `/research/portal/portal-documents-review-2026-06.html` | навигация | — | Standalone HTML-версия review-tool без внешних зависимостей: full-width layout, sticky navigation, responsive full-width tables, color-coded statuses, checkboxes, textarea и локальное сохранение решений в браузере. Scope: portal. | ✅ Да | `research/portal/portal-documents-review-2026-06.md` |
| `/research/portal/portal-documents-review-2026-06.png` | скриншот | — | Desktop screenshot of the standalone HTML review-tool for PR visual verification: full-width layout, sticky navigation, status badges and the documents table in the first viewport. Scope: portal. | ✅ Да | `research/portal/portal-documents-review-2026-06.html`, `research/portal/portal-documents-review-2026-06.md` |
...
| `/research/portal/` | каталог | — | Исследования направления «портал `open-ai.ru`» (`scope: portal`): документация, архитектура и стек, структура репозитория, AI и `mango_ba_prompts`, плюс review-tool для согласования отложенных portal-документов. | ✅ Да | `research/portal/README.md`, `standards/research-profile.md`, `governance/repo-model.md` |
...
| `/templates/` | каталог | — | Образцы («ДНК-шаблоны») для клонирования новых проектов из Хаба. | ⚠️ По необходимости | `templates/spoke/AI_GOVERNANCE.md`, `templates/spoke/README.md` |

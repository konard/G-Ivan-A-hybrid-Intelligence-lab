...
| `/standards/executable-documentation-standard.md` | стандарт | справка | Разделяет descriptive documents и executable documents, задаёт atomization и practice graph для импортируемых практик. | ✅ Да | `standards/executable-contract-standard.md`, `practices/README.md`, `research/hub/international-ai-governance-practices-2026-06.md` |
...
| `/standards/webportal-product-concept-standard.md` | стандарт | справка | Product Concept (L2) стандарт веб-портала: целевые аудитории, jobs-to-be-done, MVP scope, user flows, success metrics и high-level roadmap. Статус `draft` (предложен на утверждение фаундеру). | ⚠️ По необходимости | `standards/product-profile.md`, `standards/webportal-solution-concept-standard.md`, `templates/webportal-product-concept-template.md` |
| `/standards/webportal-solution-concept-standard.md` | стандарт | справка | Solution Concept (L3) стандарт веб-портала: C4 architecture, technology stack, integration points, data model, NFR, deployment strategy, risks and provider-agnostic AI architecture. Статус `draft` (предложен на утверждение фаундеру). | ⚠️ По необходимости | `standards/webportal-product-concept-standard.md`, `templates/webportal-solution-concept-template.md`, `standards/contract-documentation-standard.md` |

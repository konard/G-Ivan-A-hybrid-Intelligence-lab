...
# ADR-005: Структура Analysis-артефактов и принятие Варианта C из RFC B-025
...
(B-018) и в маршрутизации Research / Analysis / Audit из ADR-003; ADR-005 не
...
- ADR-002/ADR-003 остаются в силе без изменений: routing R/A/A и определения
  Analysis не переписываются; ADR-005 подтверждает существующий routing-источник.

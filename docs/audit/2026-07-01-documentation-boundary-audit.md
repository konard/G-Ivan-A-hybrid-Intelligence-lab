...
| 2 | [`docs/rfc/2026-06-30-rfc-research-structure.md`](../rfc/2026-06-30-rfc-research-structure.md) (RFC B-016, v0.2) | RFC | IL-3 | inventory #288 + audit #290 | дублирование Research (benchmark/inventory) |
...
| `docs/rfc/2026-06-30-rfc-research-structure.md` | ✅ **Соответствует**: Research не дублирован (делегирование, не копия) | Нет | N-03 (clean); F-02 |
...
### 2.3 `docs/rfc/2026-06-30-rfc-research-structure.md` (RFC B-016) — ✅ соответствует
...
sed -n '20,21p' docs/rfc/2026-06-30-rfc-research-structure.md
...
- [`docs/rfc/2026-06-30-rfc-research-structure.md`](../rfc/2026-06-30-rfc-research-structure.md) — RFC B-016, v0.2 (source ADR-003).

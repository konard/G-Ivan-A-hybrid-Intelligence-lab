...
(статус `TODO` в [backlog](../../governance/backlog.md#L235)), при этом уже
...
- **Метод:** сравнение фактического содержимого стандартов (не пересказ RFC/ADR).
  ...
  из [RFC B-025](../../governance/rfc/2026-07-02-rfc-analysis-structure.md) и
...
- [RFC B-025 (analysis-structure)](../../governance/rfc/2026-07-02-rfc-analysis-structure.md)
...
- [`governance/backlog.md`](../../governance/backlog.md) — статус B-027 = `TODO`
...
> стандартов этот документ имеет audit-подобные черты (проверка против нормы
> консистентности + findings + критичность). Он размещён в `docs/report/` согласно
> явному требованию DoD issue #370 и оформлен как аналитический report-профиль;
> нормативный аудит состояния артефактов в задачу не входил (ограничение issue #370).
</content>
</invoke>

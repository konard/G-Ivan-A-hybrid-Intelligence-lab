...
[Resolve Artifact Location proposal](../governance/rfc/resolve-artifact-location-proposal.md). Проект берёт
...
| [Knowledge Lifecycle proposal](../governance/rfc/knowledge-lifecycle-proposal.md) | Стандарт движения знания от observation до deprecation/archive. |
| [Resolve Artifact Location proposal](../governance/rfc/resolve-artifact-location-proposal.md) | Resolver для выбора места нового артефакта и фиксации нарушений lifecycle. |

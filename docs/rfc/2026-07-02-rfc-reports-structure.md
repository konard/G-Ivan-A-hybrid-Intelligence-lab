...
2. **Корпус инвентаризирован.**
   [Analysis (issue #310)](../analysis/2026-07-01-reports-artifacts-inventory.md)
...
- **Reports ↔ Analysis.** Report фиксирует «что» (descriptive); Analysis
  ...
  ([Analysis §3](../analysis/2026-07-01-reports-artifacts-inventory.md);
  Research BC-1, BC-4).
...
- [ADR-004](../adr/2026-07-adr-004-reports-structure.md) (B-042) —
...
- [ADR-004](../adr/2026-07-adr-004-reports-structure.md) / issue
  ...
  reconciliation.
- [Reports inventory and boundaries](../analysis/2026-07-01-reports-artifacts-inventory.md) —

...
Analysis ↔ Audit
([Audit deep analysis](../analysis/2026-07-02-audit-artifacts-deep-analysis.md),
...
1. **Корпус инвентаризирован.**
   [Analysis inventory (issue #342, B-024)](../analysis/2026-07-02-analysis-artifacts-inventory.md)
...
3. **Границы уточнены соседними цепочками.**
   [Audit deep analysis (B-029)](../analysis/2026-07-02-audit-artifacts-deep-analysis.md)
...
- **Analysis ↔ Research.** Research генерирует новое внешнее/доменное знание
  ...
  ([B-024 §4](../analysis/2026-07-02-analysis-artifacts-inventory.md);
...
- **Analysis ↔ Audit.** Audit проверяет соответствие норме/контракту с pass/fail и
  ...
  ([B-029](../analysis/2026-07-02-audit-artifacts-deep-analysis.md);
  [B-024 §4](../analysis/2026-07-02-analysis-artifacts-inventory.md)).
...
[B-024](../analysis/2026-07-02-analysis-artifacts-inventory.md); здесь
...
[ADR-006](../adr/2026-07-adr-006-analysis-structure.md). Переход в
...
- [Analysis inventory and boundaries](../analysis/2026-07-02-analysis-artifacts-inventory.md) —
...
- [Audit artifacts deep analysis](../analysis/2026-07-02-audit-artifacts-deep-analysis.md) —

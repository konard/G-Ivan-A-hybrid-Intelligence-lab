...
[B-029 §5](../analysis/2026-07-02-audit-artifacts-deep-analysis.md). Если
...
- Канонический путь размещения Audit-артефактов —
  **`docs/audit/YYYY-MM-DD-name.md`**. В отличие от Reports (где был дрейф
  ...
  [ADR-002](../adr/2026-06-adr-002-artifact-document-methodology.md). ADR-002-реконсиляция
...
- **Тип по содержанию, не по каталогу** (content-over-path, issue #288). Audit,
  ...
  кандидаты — в [B-029 §4](../analysis/2026-07-02-audit-artifacts-deep-analysis.md);
...
([B-029 §5.3](../analysis/2026-07-02-audit-artifacts-deep-analysis.md);
...
[B-029](../analysis/2026-07-02-audit-artifacts-deep-analysis.md); здесь
...
- Замаскированные Audit под `docs/analysis/` и legacy под `research/` — routing по
  ...
  [B-029 §4](../analysis/2026-07-02-audit-artifacts-deep-analysis.md) (без
  правок в этом RFC).
...
- [Analysis artifacts inventory (B-024)](../analysis/2026-07-02-analysis-artifacts-inventory.md) —
...
- [ADR-003](../adr/2026-07-adr-003-research-structure.md) — принятая

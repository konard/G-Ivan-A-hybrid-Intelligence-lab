...
| --- | --- | --- | --- |
| **1. Governance** | Правила, роли, режимы, lifecycle, контракты. | (сквозной слой) | Methodology **L3–L4**: `GOVERNANCE.md`, `governance/`, `standards/`. **Сильный.** |
...
| Human-AI Collaboration | `GOVERNANCE.md`: Operating Modes, эскалация | Явных **уровней автономии** в терминах решения. |
...
| Уровень | Содержание |
| --- | --- |
| **L3 (детализация)** | Артефакты: ось E0–E4 в `standards/`; целевой шаблон `templates/ai-solution-architecture/`; раздел уровней автономии в `GOVERNANCE.md` или `standards/`. Директории: переиспользовать `docs/rfc/`, `standards/`, `templates/` — **без новых пустых каталогов**. Шаблоны документов: единый frontmatter (4 поля), kebab-case, ISO-даты. |
...
- [docs/rfc/research-memory-source-intelligence.md](research-memory-source-intelligence.md)
  — PR #242: Knowledge Object, Verdict Rules, source intelligence (переиспользуется
  и расширяется как BA Knowledge Object).
- [docs/rfc/repository-archetypes-template-release.md](repository-archetypes-template-release.md)

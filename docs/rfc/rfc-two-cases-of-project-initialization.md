...
- **Кейс 1 — *Runtime-онбординг*** (см. определение в [standards/glossary.md](../../standards/glossary.md)):
  ...
  диалога. Протокол: [ai-rules/agent-onboarding-protocol.md](../../ai-rules/agent-onboarding-protocol.md).
...
| 7 | **Ключевой артефакт Хаба** | `ai-rules/agent-onboarding-protocol.md` | `templates/htom/` (геном-шаблон) |
...
| 10 | **Canonical-точка** | [ai-rules/agent-onboarding-protocol.md](../../ai-rules/agent-onboarding-protocol.md) | [templates/htom/README.md](../../templates/htom/README.md) |
...
| 12 | **Точка входа для инструкций** | `README.md` Хаба → `ai-rules/agent-onboarding-protocol.md` | `templates/htom/README.md` |
...
| `ai-rules/agent-onboarding-protocol.md` *(уже существует как executable-контракт)* | Кейс 1 | `governance/` с короткой ссылкой из `README.md` Хаба | *Handover Prompt*, алгоритм чтения файлов, шаблон *Readback* | → этот манифест, → раздел Design Rationale & History, → README Кейса 2 |
...
1. **Уточнить `ai-rules/agent-onboarding-protocol.md`** — добавить раздел «Модель

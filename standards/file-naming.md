...
| --- | --- | --- | --- |
| **Корень репозитория** (`/`) | `UPPERCASE_WITH_HYPHENS.md` | `README.md`, `docs/concept.md`, `CHANGELOG.md` | Конвенция GitHub, файлы видны сразу |
...
| Hub `docs/audit/` | `YYYY-MM-DD-name.md` | `2026-06-11-task-execution-audit.md` |
...
Для `research/`, Hub `docs/report/`, Hub `docs/audit/` и spoke `docs/analysis/`
день обязателен:
...
Для всех полей датировки в документах, таблицах и frontmatter используется
формат ISO 8601: YYYY-MM-DD.

Примеры:

- `updated: 2026-06-15`
- Колонка «Дата актуализации фазы»: `2026-06-15`
- Колонка «Дата изучения источника»: `2026-06-15`
...
| `-Summary` | краткий | Сжатый контекст для задачи: цель, фокус, границы. | `projects-sink/AI_PROJECT_CONTEXT-Summary.md` |
...
- Базовое имя файла подчиняется обычному правилу расположения: корневые файлы —
  `UPPERCASE_WITH_HYPHENS` (например, `projects-sink/AI_PROJECT_CONTEXT-Summary.md`), вложенные

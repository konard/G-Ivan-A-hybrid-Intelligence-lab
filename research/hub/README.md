...
| [2026-07-01-reports-artifacts-inventory.md](2026-07-01-reports-artifacts-inventory.md) | Analysis input для issue #310 (B-038): инвентаризация Reports-артефактов в Hub, Mango и Clarify по подтипам `audit` / `report` / `statistics`, границы Reports ↔ Analysis ↔ Audit, modernization candidates и подтверждение scope Варианта C без создания стандарта и без перемещения файлов. |
...
| [exp-reports-inventory-310/](exp-reports-inventory-310/) | Воспроизводимый scan для issue #310: матрица Reports-кандидатов по Hub, Mango и Clarify с подтипами `audit`, `report`, `statistics` и relation к Analysis/Audit. |

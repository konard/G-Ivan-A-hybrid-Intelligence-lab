...
| [2026-06-23-repository-structure-concept.md](2026-06-23-repository-structure-concept.md) | Дополнение к mango-исследованию структуры каталогов (issue #263): фиксация видения фаундера как приоритетной базы, закрытие 4 открытых вопросов и 3 противоречий, критический анализ рисков, концепция базовых/рекомендуемых/специфичных каталогов для 4 архетипов PR #243 с 10+ международными проектами на архетип и рекомендациями по синхронизации. **Часть II (§14–§22, issue #274):** до-исследование Соглашения «Архитектура инфраструктуры проектов экосистемы» — структурированная фиксация, дельта-проверка по индустриальным нормам, соотнесение уровней IL с нормой исполнимости, ортогональность IL осям Diátaxis/DITA, опровержение заложенной некорректной постановки. |
| [2026-06-25-artifact-inventory-and-classification.md](2026-06-25-artifact-inventory-and-classification.md) | Полная инвентаризация артефактов обоих репозиториев экосистемы (`mango_ba_prompts` + Хаб, issue #265) и их классификация по четырём ортогональным осям (уровень абстракции L0–L4, 8 областей знаний, архетип, статус); разбор конфликта четырёх несовместимых лестниц «L1–L4» с предложением нейтральной оси маршрутизации; наложение на 4 исследования; список cleanup-кандидатов (рекомендации, без удаления) и правила маршрутизации артефактов для AI-агентов (RT-01…RT-10). |

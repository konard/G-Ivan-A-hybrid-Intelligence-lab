...
([research/hub/2026-05-team-c-governance-strategy-audit.md](2026-05-team-c-governance-strategy-audit.md)).
...
> [2026-05-team-c-governance-strategy-audit.md](2026-05-team-c-governance-strategy-audit.md)
...
| Threat awareness | Раздел «Что может пойти не так»: 3–5 рисков в человекочитаемом виде. | `governance/agent-onboarding-protocol.md` (проектируется в RFC онбординга) | `[C5]` |
...
| --- | --- |
| [governance/agent-onboarding-protocol.md](../../governance/agent-onboarding-protocol.md) | Canonical-контракт онбординга (Кейс 1), дизайн которого учитывает рекомендации Команды С. |
...
| [research/hub/2026-06-ai-collaboration-retrospective.md](2026-06-ai-collaboration-retrospective.md) | Контекст ошибок холодного старта; обоснование fail-closed и threat awareness. |
| [research/hub/2026-05-team-c-governance-strategy-audit.md](2026-05-team-c-governance-strategy-audit.md) | Предыдущий аудит Команды С; источник принципа «нет governance-артефакта без боли» и границы анализа. |

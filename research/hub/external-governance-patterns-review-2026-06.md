...
([governance/rfc/rfc-agent-onboarding-protocol.md](../../governance/rfc/rfc-agent-onboarding-protocol.md))
...
> источник» из
> [rfc-agent-onboarding-protocol.md](../../governance/rfc/rfc-agent-onboarding-protocol.md).
...
| --- | --- |
| [governance/rfc/rfc-agent-onboarding-protocol.md](../../governance/rfc/rfc-agent-onboarding-protocol.md) | RFC онбординга (Кейс 1), ради review которого Команда С дала рекомендации. |

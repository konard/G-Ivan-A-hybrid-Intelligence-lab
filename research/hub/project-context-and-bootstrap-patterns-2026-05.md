...
| `TC-GOV-002` | `research/hub/team-c-governance-strategy-audit-2026-05.md` | Описать lightweight governance hierarchy. | repo-wide | high | medium | idea | подготовить issue на `governance/repo-model.md` или отдельный раздел в existing governance | - |

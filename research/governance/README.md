...
| Решение за человеком | Перевод в `reviewed`/`canonical` и принятие стандарта как обязательного — за фаундером ([AI_GOVERNANCE.md](../../ai-governance/ai-governance.md), правило 4). |

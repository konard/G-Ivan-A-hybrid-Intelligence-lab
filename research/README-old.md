...
| [repository-governance/](repository-governance/) | Сравнение подходов команд к структуре и governance репозитория, итоговое видение и черновик issue на изменения (issue #13). |

...
| Governance становится first-class architecture layer. | AI-агент при bootstrap должен читать `AI_GOVERNANCE.md`, `CONTRIBUTING.md`, `governance/REPO_MODEL.md` и ближайший README до создания артефактов. |
...
7. Нужна ли отдельная governance hierarchy сейчас, или достаточно встроить ее в
   существующий `governance/REPO_MODEL.md`?

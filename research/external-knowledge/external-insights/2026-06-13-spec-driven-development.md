...
- Перекликается с исследованием жизненного цикла требований Mango
  ([research/mango/2026-05-26-requirements-lifecycle-uncertainty.md](../../../research/mango/2026-05-26-requirements-lifecycle-uncertainty.md)).
...
- **Гипотеза проверки:** прогнать SDD-цикл на одном реальном кейсе требований
  ...
  ([research/mango/2026-05-22-requirements-flow.md](../../../research/mango/2026-05-22-requirements-flow.md)).

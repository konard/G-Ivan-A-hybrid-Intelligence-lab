...
source: git history before migration to research/mango/2026-05-classification.md
---
...
- «Зеркало спроса» — корпус из 30 ТЗ и проверка эталона на нём — ведётся отдельно в [2026-05-classification-tz.md](2026-05-classification-tz.md). Сырой спрос не интегрируется в этот файл; сюда переносятся только нормализованные продуктовые классы (см. §«Что нового в версии 3.0»).
...
Раздел фиксирует атрибуты, которые проявились в анализе корпуса ТЗ (`2026-05-classification-tz.md`, рекомендации R2.6–R2.8), но осознанно **не вносятся** в основную модель v3.0. Они не являются продуктовыми классами и при преждевременном включении раздули бы таксономию (нарушение Anti-Inflation principle, см. [governance/repo-model.md](../../governance/repo-model.md)). Каждый атрибут описан с обоснованием отсрочки и критерием активации в будущей версии.

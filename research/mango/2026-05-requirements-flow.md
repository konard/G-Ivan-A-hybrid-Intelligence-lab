...
source: git history before migration to research/mango/2026-05-requirements-flow.md
---
...
Связанный документ: [Классификация IT/Telecom SaaS-продуктов MANGO OFFICE](2026-05-classification.md).
...
2. Каждое требование нормализуется до проверяемой формулировки по терминологии IT/Telecom и получает классификацию из `2026-05-classification.md`: продуктовая зона, capability, статус MANGO OFFICE, TM Forum domain/capability, UNSPSC/ОКПД 2 и compliance-trigger.
...
| FR-06 | Система должна классифицировать требования по рабочей таксономии MANGO OFFICE из `2026-05-classification.md`: product family, Mango status, Mango product, TM Forum domain/capability, UNSPSC, ОКПД 2, standards overlay и compliance trigger. | Классифицированное требование. |

...
Документ остается черновиком исследования (`draft`). Перевод в `reviewed` и утверждение
...
- Профиль и правила оформления: [standards/research-profile.md](../../standards/research-profile.md), [standards/research-profile.md](../../standards/research-profile.md).
...
- **Тяжёлые формальные фреймворки** (ISO/IEC/IEEE 42010, TOGAF, BABOK) — полны и
  ...
  ([governance/repo-model.md](../../governance/repo-model.md)) на старте.

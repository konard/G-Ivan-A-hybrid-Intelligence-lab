...
Документ остается черновиком для согласования (RFC, режим `creative`). **Решение — за
...
- **Структура:** геном спока + 5 портал-каталогов (`projects/`, `presentations/`,
  ...
  [portal-repository-structure.md](../../standards/portal-repository-structure.md).
...
- **Структура:** портал-спок + стандарт [portal-repository-structure.md](../../standards/portal-repository-structure.md).
...
4. **Стандарт структуры:** утвердить [portal-repository-structure.md](../../standards/portal-repository-structure.md)
...
- Приложение E — Стандарт: [portal-repository-structure.md](../../standards/portal-repository-structure.md).

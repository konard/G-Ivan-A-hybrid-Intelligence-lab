...
| Хаб [`rfc-two-cases-of-project-initialization.md`]({{hub_url}}/blob/main/governance/proposals/rfc-two-cases-of-project-initialization.md) | Манифест двух кейсов: чем Кейс 2 (этот файл) отличается от Кейса 1. |
| Хаб [`rfc-creative-template-design.md`]({{hub_url}}/blob/main/governance/proposals/rfc-creative-template-design.md) | Дизайн «ДНК-шаблона» спока: почему геном именно такой. |

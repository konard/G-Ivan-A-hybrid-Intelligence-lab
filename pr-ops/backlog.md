...
| **B-080** | План миграции Mango | **P2** | B-079 | review | [#436](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/436) | ADR-009 (B-079); issues #411, #413; снимок `mango_ba_prompts@295b65d` | На основе ADR-009 составлен детальный план миграции: `docs/analysis/2026-07-17-mango-artifacts-migration-plan.md`. Построен на фактическом снимке (5 346 файлов, 1 337 с брендом «Mango»), а не на концептуальном списке: правила классификации R1–R8 (fail-safe по умолчанию), процесс обезличивания A1–A8 с обязательным gate до первого push, таблица миграции по всем корневым каталогам, расщепление глоссария как стратегия пограничного кейса, фазы 0–5, риски. Два блокирующих Open Question фаундеру: репозиторий фактически публичный (Q1) и отсутствие дома для `kb/` — 95% объёма (Q2). B-083 не стартует до их закрытия. | Hybrid |
